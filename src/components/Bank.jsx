...
const Bank = () => {
    ...
    return (
        <div className=' h-full bg-[#f4fbf4] sm:h-[700px] md:h-[950px] relative'>
            ...
            <div className="options text-center flex bg-[rgb(48,177,49)] p-3 text-white text-lg items-center font-medium">
            ...
            <div className='mb-3'>
                <button onClick={handleSubmit} className='bg-[rgb(48,177,49)] text-white mx-auto text-lg mb-20 rounded-full shadow-xl block w-4/5 py-2 shadow-red-200'>Confirm</button>
            </div>
        </div>
    )
}
