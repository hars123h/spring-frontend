...
const ChangeWithdrawalPassword = () => {
    ...
    return (
        <div className='bg-[#f7f9f8] h-screen sm:h-[700px] md:h-[950px] relative'>
            ...
            <div className="options text-center flex bg-[rgb(48,177,49)] shadow-lg font-medium items-center p-3">
            ...
            <div className='flex'>
                ...
                className='bg-[rgb(48,177,49)] w-[90%] text-white text-lg mt-5 mb-20 rounded-lg mx-auto block py-2 shadow-md'>Confirm</button>
            </div>
        </div>
    )
}
