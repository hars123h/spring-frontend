...
import s1 from '../images/boing_space/s1.jpg';
import s2 from '../images/boing_space/s2.jpg';
import s3 from '../images/boing_space/s3.jpg';
import s4 from '../images/boing_space/s4.jpg';
import s5 from '../images/boing_space/s5.jpg';
import s6 from '../images/boing_space/s6.jpg';
...
const Home = () => {
    ...
    const getUserDetails = async () => {
        await axios.post(`${BASE_URL}/get_user`, { user_id: localStorage.getItem('uid') }).then(({ data }) => {
            if (data) {
                const tempPlans = data.plans_purchased.filter((element)=>element.plan_name==='Spring Airlines 1');
    ...
    const closeModal = async (action) => {
        ...
        if (action === 'cancel') {
            setIsOpen(false);
        }else if(firstPlanPurchased===true && currPlan.plan_name==='Spring Airlines 1') {
            setIsOpen(false);
        ...
        <div className='relative bg-[#eaf4eb]'>
            ...
            <div>
                ...
                >
                    ...
                    <div>
                        <button onClick={() => closeModal('ok')} className='bg-[rgb(48,177,49)] text-white px-2 py-1 rounded-lg shadow-md w-[64px]'>Yes</button>
                        <button onClick={() => closeModal('cancel')} className='bg-[rgb(48,177,49)] text-white px-2 py-1 rounded-lg shadow-md w-[64px] ml-2'>cancel</button>
                    </div>
                </ReactModal>
            </div>
                ...
                >
                    <div className='w-full rounded-lg shadow-xl z-10  border border-gray-400'>
                        <div className='flex gap-2 flex-col bg-white w-full text-blue-500 rounded-md'>
                            <div className='bg-[rgb(48,177,49)] text-center p-1 text-lg shadow-md text-white'>Notice</div>
                            <div className='flex flex-col p-2 text-gray-600 text-xs gap-2 font-bold'>
                                <div>Welcome to Spring Airlines investment Platform</div>
                                <div>Let  Spring Airlines create unlimited wealth with you.</div>
                                <div>The  Spring Airlines app is officialy launched, let us walk together on the road to wealth.</div>
            ...
            <div className="bg-[rgb(48,177,49)] rounded-full items-center px-2 text-white relative flex overflow-x-hidden h-10 mx-auto mt-2 border-2 border-gray-100 sm:w-3/5 lg:w-3/5 overflow-y-hidden">
                <div>
                    <VolumeUpOutlined />
                </div>
                    ...
                    <div className='grid grid-cols-1 gap-1'>
                        {userDetails && (amountDetails.plan_state[0] === 0) ? (
                            <span className='pointer-events-none'>
                                <Card product_type={"long"} product_image={s1} handleClick={handleClick} plan_name={"Spring Airlines 1"} plan_cycle={60} plan_daily_earning={20} plan_amount={0} plan_type={'Big Plan'} />
                            </span>
                        ) : (
                            <span>
                                <Card product_type={"long"} product_image={s1} handleClick={handleClick} plan_name={"Spring Airlines 1"} plan_cycle={60} plan_daily_earning={20} plan_amount={0} plan_type={'Big Plan'} />
                        ...
                        {userDetails && (amountDetails.plan_state[1] === 0) ? (
                            <span className='pointer-events-none'>
                                <Card product_type={"long"} product_image={s2} handleClick={handleClick} plan_name={"Spring Airlines 2"} plan_cycle={60} plan_daily_earning={110} plan_amount={480} plan_type={'Big Plan'} />
                            </span>
                        ) : (
                            <span>
                                <Card product_type={"long"} product_image={s2} handleClick={handleClick} plan_name={"Spring Airlines 2"} plan_cycle={60} plan_daily_earning={110} plan_amount={480} plan_type={'Big Plan'} />
                        ...
                        {userDetails && (amountDetails.plan_state[2] === 0) ? (
                            <span className='pointer-events-none'>
                                <Card product_type={"long"} product_image={s3} handleClick={handleClick} plan_name={"Spring Airlines 3"} plan_cycle={60} plan_daily_earning={150} plan_amount={800} plan_type={'Big Plan'} />
                            </span>
                        ) : (
                            <span>
                                <Card product_type={"long"} product_image={s3} handleClick={handleClick} plan_name={"Spring Airlines 3"} plan_cycle={60} plan_daily_earning={150} plan_amount={800} plan_type={'Big Plan'} />
                        ...
                        {userDetails && (amountDetails.plan_state[3] === 0) ? (
                            <span className='pointer-events-none'>
                                <Card product_type={"long"} product_image={s4} handleClick={handleClick} plan_name={"Spring Airlines 4"} plan_cycle={30} plan_daily_earning={350} plan_amount={1800} plan_type={'Big Plan'} />
                            </span>
                        ) : (
                            <span>
                                <Card product_type={"long"} product_image={s4} handleClick={handleClick} plan_name={"Spring Airlines 4"} plan_cycle={30} plan_daily_earning={350} plan_amount={1800} plan_type={'Big Plan'} />
                        ...
                        {userDetails && (amountDetails.plan_state[4] === 0) ? (
                            <span className='pointer-events-none'>
                                <Card product_type={"long"} product_image={s5} handleClick={handleClick} plan_name={"Spring Airlines 5"} plan_cycle={30} plan_daily_earning={600} plan_amount={3500} plan_type={'Big Plan'} />
                            </span>
                        ) : (
                            <span>
                                <Card product_type={"long"} product_image={s5} handleClick={handleClick} plan_name={"Spring Airlines 5"} plan_cycle={30} plan_daily_earning={600} plan_amount={3500} plan_type={'Big Plan'} />
                        ...
                        {userDetails && (amountDetails.plan_state[5] === 0) ? (
                            <span className='pointer-events-none'>
                                <Card product_type={"long"} product_image={s6} handleClick={handleClick} plan_name={"Spring Airlines 6"} plan_cycle={30} plan_daily_earning={2500} plan_amount={15000} plan_type={'Big Plan'} />
                            </span>
                        ) : (
                            <span>
                                <Card product_type={"long"} product_image={s6} handleClick={handleClick} plan_name={"Spring Airlines 6"} plan_cycle={30} plan_daily_earning={2500} plan_amount={15000} plan_type={'Big Plan'} />
