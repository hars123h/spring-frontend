...
const Invite = () => {
    ...
    if (loading || userDetails === null) {
        return (
            <div className=' bg-[rgb(48,177,49)] h-[1000px] flex flex-col text-white font-light p-5 relative'>
                ...
                <div className="flex gap-2">
                    ...
                    <div className="info w-1/2 p-3 sm:text-xs md:text-md flex flex-col gap-2 rounded-lg bg-white text-vlt font-bold mt-5">
                        ...
                        <CopyToClipboard text={''} onCopy={() => toaster('Copied to clipboard')}>
                            <span className='mx-auto bg-[rgb(48,177,49)] text-white p-2 rounded-md'>Copy code</span>
                        </CopyToClipboard>
                    </div>
                </div>
            </div>
