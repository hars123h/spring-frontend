...
import boeing_logo from '../images/boing_space/boeing_logo.jpg';
        ...
        <div  className='relative   bg-white '>
            ...
            <div className='flex flex-col m-auto w-5/6 mt-2'>
                ...
                <div className='mt-4'>
                    ...
                    className='bg-[rgb(48,177,49)] w-full pt-2 pb-2 text-lg text-white rounded-full shadow-md shadow-blue-400
                    '>Log in</button>
                </div>
                {/*[#379EFE] */}
