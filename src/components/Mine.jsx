        ...
        <div className="top h-40">
          ...
          <div className="h-26 overflow-y-visible rounded-xl  info_box bg-[#ffffff] text-gray-500 flex flex-col shadow-lg shadow-gray-400  items-center justify-between w-[90%] mx-auto mt-6 px-4 py-2">
            ...
            <div className='flex gap-4 text-white'>
              <div className='rounded-full text-center px-4 py-1 bg-[rgb(48,177,49)] w-32 shadow-lg' >Recharge</div>
              {isBetween() === false ? (
                <div className='bg-[rgb(48,177,49)] text-center rounded-full px-4 py-1 w-32 shadow-lg' >Withdraw</div>
              ) : (
                <div className='bg-[rgb(48,177,49)] text-center rounded-full px-4 py-1 w-32 shadow-lg' >Withdraw</div>
              )}
            </div>
      ...
      <div className='flex flex-col mine_image'>
        ...
        <div className="top h-40">
          ...
          <div className="h-26 overflow-y-visible rounded-xl  info_box bg-[#ffffff] text-gray-500 flex flex-col shadow-lg shadow-gray-400  items-center justify-between w-[90%] mx-auto mt-6 px-4 py-2">
            ...
            <div className='flex gap-4 text-white'>
              <div className='rounded-full text-center px-4 py-1 bg-[rgb(48,177,49)] w-32 shadow-lg' onClick={() => navigate('/recharge')}>Recharge</div>
              {isBetween() === false && false ? (
                <div className='bg-[rgb(48,177,49)] text-center rounded-full px-4 py-1 w-32 shadow-lg' onClick={() => toaster('You can withdraw only between 9:00 to 19:00 hours only.')}>Withdraw</div>
              ) : (
                <div className='bg-[rgb(48,177,49)] text-center rounded-full px-4 py-1 w-32 shadow-lg' onClick={() => navigate('/withdrawal', { state: { withdrawalPassword: originalwpwd, loginPassword: originalpwd } })}>Withdraw</div>
              )}
            </div>
          </div>
        </div>
