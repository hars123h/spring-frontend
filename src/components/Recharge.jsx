...
const Recharge = () => {
    ...
    return (
        <div className='bg-[#f7f9f8] h-screen relative'>
            ...
            <div className="options text-center flex items-center bg-[rgb(48,177,49)] text-white text-md p-3 font-normal mb-4">
            ...
            <div className="cnf_recharge w-4/5 mx-auto mt-10">
                <button onClick={handleRecharge} className='w-full bg-[rgb(48,177,49)] py-2 rounded-md text-white text-lg font-bold shadow-customShadow shadow-cyan-200'>Confirm Recharge</button>
            </div>
        </div>
    )
}
