...
const RechargeWindow = () => {
    ...
    return (
        <div className='sm:h-[700px] md:h-[950px] flex flex-col gap-4  bg-white relative'>
            ...
            <div className="options text-center text-white flex gap-2 items-center p-2  bg-[rgb(48,177,49)] text-lg pt-2 font-medium">
            ...
            <div className='flex flex-col gap-4 p-8'>
                ...
                <div className="box flex rounded-lg p-6 flex-col mt-3 bg-[rgb(48,177,49)] text-white">
                ...
                <button onClick={handleRecharge} className='bg-[rgb(48,177,49)] text-white p-4 rounded-lg text-lg shadow-lg shadow-gray-400'>Submit</button>
