            ...
            {isloading ? <>
                ...
                <div className="flex flex-col items-center w-full">
                    ...
                    <div className="flex w-[98%] flex-col font-bold border bg-white border-gray-300 shadow-lg mt-2 rounded-lg mx-auto p-3 gap-2">
                        ...
                        <button className='bg-[rgb(48,177,49)] p-3 text-white shadow-md rounded-md '>Redeem Code</button>
                    </div>
                </div>
            </> : <>
                <div className="options text-center text-white flex gap-2 items-center p-2  bg-[rgb(48,177,49)] text-lg pt-2 font-medium">
                ...
                <div className="flex flex-col items-center w-full">
                    ...
                    <div className="flex w-[98%] flex-col font-bold border bg-white border-gray-300 shadow-lg mt-2 rounded-lg mx-auto p-3 gap-2">
                        ...
                        <button onClick={getReward2} className='bg-[rgb(48,177,49)] p-3 text-white shadow-md rounded-md '>Redeem Code</button>
                    </div>
                </div>
            </>}
        </div>
