...
// import s7 from '../images/boing_space/p7.jpg';
...
const ShortPlans = () => {
    ...
    return (
        <div className='relative bg-[#eaf4eb]'>
            ...
            <div className='bg-[rgb(48,177,49)] py-3 shadow-lg px-3 flex justify-center items-center'>
                ...
                {currentVisible === 'short' && amountDetails?.plan_state && userDetails && (
                    <div className={`grid grid-cols-1 gap-1`}>
                        {(userDetails.boughtLong < 1 || amountDetails.plan_state[6] === 0) ?
                            (
                                <span className='pointer-events-none'>
                                    {/* <span>hi</span> */}
                                    <Card product_type={"short"} product_image={s1} handleClick={handleClick} plan_name={"Spring Airlines 7"} plan_cycle={1} plan_daily_earning={130} plan_amount={110} plan_type={'Short Plan'} />
                                </span>
                            ) :
                            <span>
                                <Card product_type={"short"} product_image={s1} handleClick={handleClick} plan_name={"Spring Airlines 7"} plan_cycle={1} plan_daily_earning={130} plan_amount={110} plan_type={'Short Plan'} />
                        ...
                        {(userDetails.boughtLong < 1 || amountDetails.plan_state[7] === 0) ?
                            (<span className='pointer-events-none'>
                                <Card product_type={"short"} product_image={s2} handleClick={handleClick} plan_name={"Spring Airlines 8"} plan_cycle={3} plan_daily_earning={140} plan_amount={330} plan_type={'Short Plan'} />
                            </span>) :
                            (<span className=''>
                                <Card product_type={"short"} product_image={s2} handleClick={handleClick} plan_name={"Spring Airlines 8"} plan_cycle={3} plan_daily_earning={140} plan_amount={330} plan_type={'Short Plan'} />
                            </span>
                        ...
                        {(userDetails.boughtLong < 1 || amountDetails.plan_state[8] === 0) ?
                            (<span className='pointer-events-none'>
                                <Card product_type={"short"} product_image={s3} handleClick={handleClick} plan_name={"Spring Airlines 9"} plan_cycle={4} plan_daily_earning={360} plan_amount={1160} plan_type={'Short Plan'} />
                            </span>) :
                            (<span className=''>
                                <Card product_type={"short"} product_image={s3} handleClick={handleClick} plan_name={"Spring Airlines 9"} plan_cycle={4} plan_daily_earning={360} plan_amount={1160} plan_type={'Short Plan'} />
                            </span>
                        ...
                        {(userDetails.boughtLong < 1 || amountDetails.plan_state[9] === 0) ?
                            (<span className='pointer-events-none'>
                                <Card product_type={"short"} product_image={s4} handleClick={handleClick} plan_name={"Spring Airlines 10"} plan_cycle={4} plan_daily_earning={810} plan_amount={2800} plan_type={'Short Plan'} />
                            </span>) :
                            (<span className=''>
                                <Card product_type={"short"} product_image={s4} handleClick={handleClick} plan_name={"Spring Airlines 10"} plan_cycle={4} plan_daily_earning={810} plan_amount={2800} plan_type={'Short Plan'} />
                            </span>
                        ...
                        {(userDetails.boughtLong < 1 || amountDetails.plan_state[10] === 0) ?
                            (<span className='pointer-events-none'>
                                <Card product_type={"short"} product_image={s5} handleClick={handleClick} plan_name={"Spring Airlines 11"} plan_cycle={4} plan_daily_earning={3000} plan_amount={8500} plan_type={'Short Plan'} />
                            </span>) :
                            (<span className=''>
                                <Card product_type={"short"} product_image={s5} handleClick={handleClick} plan_name={"Spring Airlines 11"} plan_cycle={4} plan_daily_earning={3000} plan_amount={8500} plan_type={'Short Plan'} />
                            </span>
