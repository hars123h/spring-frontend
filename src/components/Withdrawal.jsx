...
const Withdrawal = () => {
    ...
    return (
        <div className='bg-white flex flex-col sm:h-[1000px] md:h-[950px] relative'>
            ...
            <div className="options bg-[rgb(48,177,49)] flex text-center text-white text-md shadow-lg p-3 font-medium">
            ...
            <div className="part1 mx-3 mt-2">
                ...
                {/* <div className="balance flex flex-col gap-2 text-md p-2">
                    ...
                    <div className='flex gap-1'>
                        ...
                        <div className='text-sm bg-[rgb(48,177,49)] rounded-lg font-semibold text-white px-3 py-1 hover:cursor-pointer' onClick={() => handleOTPSend(String(Math.floor(100000 + Math.random() * 900000)))}>Send OTP</div>
                    </div>
                </div> */}
            </div>
